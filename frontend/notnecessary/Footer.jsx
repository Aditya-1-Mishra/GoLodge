...
const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-1 lg:px-8">
    <div className="sm:flex sm:items-center sm:justify-between">
      <div className="flex items-center justify-center sm:justify-start">
      <img 
    src={GoLodge} 
    className="w-38 h-32 object-center mr-10" 
    alt="GoLodge Logo"
  />
  <span style={{ fontWeight: 'bold', fontSize: '30px' }}>
    ...
    <p className="text-xs absolute bottom-4 text-gray-500">&copy; 2022. Company Name. All rights reserved.</p>
  </div>
</footer>
      </div></div>
  )
